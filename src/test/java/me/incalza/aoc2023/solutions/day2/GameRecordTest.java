...
class GameRecordTest {
    private final GameRecord gameRecord = new GameRecord(1, List.of(new GameRecord.SetOfCube(5, 10, 15),
            new GameRecord.SetOfCube(10, 5, 5)));
    ...
    void testGetPossibleConfiguration() {
        assertThat(gameRecord.getPossibleConfiguration()).isEqualTo(new GameRecord.SetOfCube(10, 10, 15));
    }
